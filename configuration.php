...
class JConfig
{
	...
	public $sitename = 'blank_joomla';            // Name of Joomla site
	...
	public $host = 'localhost:30008';              // This is normally set to localhost
	...
	/* Server Settings */
	public $secret = 'KM9r1k7Ypra5PgSX';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = 'D:7\blank_joomla\code/tmp/';                // This path needs to be writable by Joomla!
	public $log_path = 'D:7\blank_joomla\code/logs/'; // This path needs to be writable by Joomla!
